        ...
        <div className={`${styles["confirmation-grid"]}`}>
          <div className={`${styles["confirmation-details"]}`}>
            <div className={`${styles["detail-group"]}`}>
              ...
              <span>{invoice?.reservation?.booking_id}</span>
            </div>
            <div className={`${styles["detail-group"]}`}>
              <label>Room Type</label>
              <span>
                #{invoice?.room?.room_number} [{invoice?.room?.room_type?.title}
                ]
              </span>
            </div>
            <div className={`${styles["detail-group"]}`}>
              ...
              <span>
                {format(invoice?.reservation?.check_in, "LLL, dd yyyy")}
              </span>
            </div>
            <div className={`${styles["detail-group"]}`}>
              <label>Check-out Date</label>
              <span>
                {format(invoice?.reservation?.check_out, "LLL, dd yyyy")}
              </span>
            </div>

            <div className={`${styles["detail-group"]}`}>
              <label>Guests</label>
              <span>{invoice?.reservation?.adults} Guests</span>
            </div>
            <div className={`${styles["detail-group"]}`}>
