...
function ReservationUpdate({ reservation }) {
  ...
  useEffect(() => {
    ...
    async function getBusyDays() {
      setIsLoading(true);
      const { data: reservations } = await getRoomReservations(
        reservation.room_id
      );
  ...
  async function handleSubmit() {
    ...
    updateFormData.set("check_in", startDate);
    updateFormData.set("check_out", endDate);
    updateFormData.set("adults", guests);
  }
        ...
        <Card.Description className={styles.overviewDescription}>
          ...
          <form className={styles.formControl}>
            <div>
              ...
              <select name="" id="" defaultValue={reservation.adults}>
            ...
            <div className="modal-update-form">
              ...
              />
              {rangeError && (
                <span className={styles.errorMessage}>{rangeError}</span>
              )}
            </div>
          </form>
